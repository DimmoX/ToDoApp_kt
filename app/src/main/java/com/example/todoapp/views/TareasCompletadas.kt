...
@Composable
fun TareasCompletadas(modifier: Modifier, navController: NavController) {
    ...
    Box(modifier = Modifier.fillMaxSize()){
        NavigationDrawer(navController) { paddingValues ->
            Scaffold(
                content = {
                    contentTaskComplete(tareasViewModel, topBarHeight)
                }
            )
        }
    }
...
@Composable
fun contentTaskComplete(tareasViewModel: TareasViewModel, topBarHeight: Dp) {
